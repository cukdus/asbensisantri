    ...
    public function index()
    {
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            array_push(
                ...
                count($this
                    ->presensiGuruModel
                    ->join('users', 'users.id = tb_presensi_guru.user_id', 'left')
                    ->where(['tb_presensi_guru.tanggal' => "$date", 'tb_presensi_guru.id_kehadiran' => '1'])
        ...
        $data = [
            ...
            'alumni' => $this->siswaModel->getAlumniCount(),
        ];
