...
$routes->group('admin', function (RouteCollection $routes) {
    ...
    $routes->get('user/register', 'Admin\DataUser::registerUser');
    $routes->post('user/register', 'Admin\DataUser::saveUser');
    // admin edit data user
    $routes->get('user/edit/(:any)', 'Admin\DataUser::formEditUser/$1');
    $routes->post('user/edit', 'Admin\DataUser::updateUser');
    // admin hapus data user
    $routes->delete('user/delete/(:any)', 'Admin\DataUser::delete/$1');
    $routes->post('user/bulk-delete', 'Admin\DataUser::bulkDelete');

    // legacy routes for backward compatibility
    $routes->get('guru', 'Admin\DataUser::index');
    $routes->post('guru', 'Admin\DataUser::ambilDataUser');
    $routes->get('petugas', 'Admin\DataUser::index');
    $routes->post('petugas', 'Admin\DataUser::ambilDataUser');
    ...
    $routes->group('general-settings', ['namespace' => 'App\Controllers\Admin'], function ($routes) {
        ...
        $routes->post('update-whatsapp', 'GeneralSettings::updateWhatsapp');
    });
});
