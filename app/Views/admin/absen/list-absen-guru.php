      ...
      <table class="table table-hover">
        ...
        ?>
               <tr>
                  ...
                  <td>
                     <?php if (!$lewat): ?>
                        <button data-toggle="modal" data-target="#ubahModal" onclick="getDataKehadiran(<?= $value['id_presensi'] ?? '-1'; ?>, <?= $value['id']; ?>)" class="btn btn-info p-2" id="<?= $value['id']; ?>">
