...
// Test untuk menambahkan siswa baru dan melihat hasilnya
echo "<h2>Test Tambah Siswa Baru untuk Demo Belum Absen</h2>";
echo "<hr>";
...
try {
    ...
    // Insert siswa baru
    $stmt = $pdo->prepare("INSERT INTO tb_siswa (nis, nama_siswa, id_kelas, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_telp, email) 
                          VALUES (?, ?, ?, 'L', 'Jakarta', '2010-01-01', 'Jl. Test', '08123456789', 'test@email.com')");
    $stmt->execute([$new_nis, 'Siswa Test Belum Absen', 14]);
